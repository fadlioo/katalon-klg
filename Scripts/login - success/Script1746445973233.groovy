...
WebUI.setText(findTestObject('Login Page/Page_login/input_Username_username'), findTestData('Credential').getValue(1, 1))
...
WebUI.verifyElementNotPresent(findTestObject('Login Page/Page_login/p_Login failed Please ensure the username and password are valid'), 
    0)
